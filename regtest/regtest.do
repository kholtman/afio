...
function dircomp { export d1=$1; export d2=$2; export cmpflag=$3; bash -c ./dircompare; };
...
cd t2
if ! find afiot | $NEWAF -oZ ../t2.afn; then
 failure
fi
cd $wd
...
cd t2
if ! find afiot | $OLDAF -oZ ../t2.afo; then
 failure
fi
cd $wd
...
cd t2
if ! find afiot -print0 | $NEWAF -oZ -f -s 10m -0 ../t2.afnb; then
 failure
fi
cd $wd
